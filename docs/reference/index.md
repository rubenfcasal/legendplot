...
- [`legendplot-package`](https://rubenfcasal.github.io/legendplot/reference/legendplot-package.md)
  [`legendplot`](https://rubenfcasal.github.io/legendplot/reference/legendplot-package.md)
  : legendplot: Standard and 'rgl' Plots with Legends

## Standard plots with legends

Functions for creating standard R plots with continuous or categorical
legends.
...
## ‘rgl’ plots with legends

Functions for creating ‘rgl’ 3d plots with continuous or categorical
legends.
...
Color palettes and functions for assigning colors to values.
...
Utilities for working with the ‘rgl’ package.
...
Examples of data and 3d objects.

- [`volcanom`](https://rubenfcasal.github.io/legendplot/reference/volcanom.md)
